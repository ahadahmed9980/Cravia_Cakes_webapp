...
class ProductDetailPageexpanded2 extends StatefulWidget {
  const ProductDetailPageexpanded2({super.key});

  @override
  State<ProductDetailPageexpanded2> createState() => _ProductDetailPageexpanded2State();
}

class _ProductDetailPageexpanded2State extends State<ProductDetailPageexpanded2> {
  @override
