      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 40),
            Container(height: 0.3, color: Colors.grey, width: double.infinity),
            SizedBox(height: 5),
            ...
            Row(
              children: [
                Obx(
                  () => MouseRegion(
                    onEnter: (_) => controller.islesshovering.value = true,
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: controller.islesshovering.value ? dark : org,
                        borderRadius: BorderRadius.circular(50),
                        boxShadow: [
                          BoxShadow(
                ...
                Obx(
                  () => MouseRegion(
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: controller.isaddhovering.value ? dark : org,
                        borderRadius: BorderRadius.circular(50),
                        boxShadow: [
                          BoxShadow(
                            color: Colors.orangeAccent,
                ...
                Obx(
                  () => MouseRegion(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: controller.isadtocarthoverig.value ? dark : org,
                        borderRadius: BorderRadius.circular(13),
                        boxShadow: [
                          BoxShadow(
                            color: Colors.orangeAccent,
